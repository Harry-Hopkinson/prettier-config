      ...
      async () => {
        ...
        if (activeEditor && !textEditor.document.isDirty) {
          if (fileType === "Javascript") {
            ...
            if (activeEditor) {
              const singleQuotes = await vscode.window.showInformationMessage(
              ...
              const trailingComma = await vscode.window.showInformationMessage(
              ...
              const endOfLine = await vscode.window.showInformationMessage(
              ...
              const edit = await activeEditor.edit((editBuilder) => {
